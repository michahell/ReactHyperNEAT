...
EXPERIMENT_DIR="/Users/michahell/Documents/projects_c++/experimentSuite/experiment_arena_noinputs_evasion"
SAMPLE=${EXPERIMENT_DIR}/${1}


# WEBOTS 6.x original worldfile
# WORLD="/Users/michahell/Documents/projects_c++/experiment_arena_noinputs_evasion/worlds/exp7_world.wbt"

# WEBOTS 6.x original worldfile, controller names modified
WORLD="/Users/michahell/Documents/projects_c++/experimentSuite/experiment_arena_noinputs_evasion/worlds/arena_world_noinputs_evasion_1.wbt"
